    ...
    <div class="col-md-10" style="background: #fff; color:rgb(0,0,51); min-height:70vh; padding-top:10px;" >
     <!--<div class="row">
      ...
      <div class="row" style="border-bottom: 2px solid rgb(0,0,51);">
        <div class="col-md-3"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp;<b>Rescheduled Meeting</b></div>
...
<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
       echo'<tr>
              ...
              <td align="center"><a href="#" id="rescheduled_meeting_butt" class="btn btn-danger" data-toggle="modal" style="color:white;" data-id="'.$row['visitor_id'].'">Reschedule</a></td>
            </tr>'  ;
            $s_no++;
      }     
?>
...
<!-- Modal For Resheduled Meeting -->
<div class="modal fade" id="rescheduled_meeting" role="dialog">
        ...
        <div class="modal-content" style="background: #fff; color:rgb(0,0,51);">
            <div class="modal-body">
                <div class="container col-md-12" style="background: #fff; color:rgb(0,0,51);"> 
                    <div class="row" style="border-bottom: 2px solid rgb(0,0,51);">
                        <div class="col-md-3"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;<b>Rescheduled Meeting</b></div>
                        <div class="col-md-4"></div>
                        <div class="col-md-2">
                    ...
                    <div class="rescheduled_meeting"></div>
                </div> 
            </div>
        </div>
    </div>
