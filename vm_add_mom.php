...
<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
       echo'<tr>
              ...
              <td align="center"><a href="#" id="add_mom_butt" class="btn btn-info" data-toggle="modal" style="color:white;" data-id="'.$row['visitor_id'].'">Add MOM</a></td>
            </tr>'  ;
            $s_no++;
      }     
?>
...
<!-- Modal For Add MOM -->
<div class="modal fade" id="add_mom" role="dialog">
